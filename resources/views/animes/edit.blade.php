            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Edit — {{ $anime->title }}</h5>
                        ...
                        <form action="{{ route('animes.update', $anime->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    id="title" name="title" value="{{ old('title', $anime->title) }}" required>
                                @error('title')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('genre') is-invalid @enderror" id="genre"
                                        ...
                                        @foreach (['Action', 'Romance', 'Isekai', 'Fantasy', 'Slice of Life', 'Horror', 'Sports', 'Mecha'] as $g)
                                            <option value="{{ $g }}"
                                                {{ old('genre', $anime->genre) == $g ? 'selected' : '' }}>
                                                {{ $g }}</option>
                                        @endforeach
                                    </select>
                                    @error('genre')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status"
                                        ...
                                        @foreach (['Watching', 'Completed', 'Plan to Watch', 'Dropped'] as $s)
                                            <option value="{{ $s }}"
                                                {{ old('status', $anime->status) == $s ? 'selected' : '' }}>
                                                {{ $s }}</option>
                                        @endforeach
                                    </select>
                                    @error('status')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('episodes') is-invalid @enderror"
                                        id="episodes" name="episodes" value="{{ old('episodes', $anime->episodes) }}"
                                        min="1" required>
                                    @error('episodes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('rating') is-invalid @enderror"
                                        id="rating" name="rating" value="{{ old('rating', $anime->rating) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('studio') is-invalid @enderror"
                                    id="studio" name="studio" value="{{ old('studio', $anime->studio) }}" required>
                                @error('studio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="url" class="form-control @error('cover_image') is-invalid @enderror"
                                    ...
                                    value="{{ old('cover_image', $anime->cover_image) }}" placeholder="https://...">
                                @error('cover_image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
